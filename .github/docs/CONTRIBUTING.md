# Contributing <Project-Lumina> </project-name

Thank you for considering contributing to Project Lumina! We welcome contributions from the community and are grateful for your support.
...
2. **Clone the Repository**: Clone your forked repository to your local machine.
    ...
    ```sh
    git clone https://github.com/dxns-hub/Lumina.git
    ```
